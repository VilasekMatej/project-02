...
# Seznam všech bitových operátorů v Pythonu:
# & - Bitový součin (AND)
# | - Bitový součet (OR)
# ^ - Bitový exkluzivní součet (XOR)
# ~ - Bitová negace (NOT)
# << - Bitový posun doleva (left shift)
# >> - Bitový posun doprava (right shift)

myself_binary= "10101101"
print(int(myself_binary,2))

shifted_binary = int(myself_binary,2) >> 2
print("Bitový posun vpravo o 2 bity:", shifted_binary)

hex_number = 0x1A
result = shifted_binary & hex_number
print(f"Bitový součin čísla 0b{shifted_binary:08b} a 0x1A je 0b{result:08b}")
